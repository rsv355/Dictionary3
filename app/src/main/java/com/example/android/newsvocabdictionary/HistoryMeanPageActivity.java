...
public class HistoryMeanPageActivity extends ActionBarActivity {
   ...
   *//*     //   ExamplePageFragment.list.setAdapter(ExamplePageFragment.adapter);
    ...
    public class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0) {
                HistoryMeaningPageFragment bm =  new HistoryMeaningPageFragment();
...
/*
                ...
                ft.add(bm2,"EXP");
                return ft;*/
                return HistoryExamplePageFragment.newInstance("","");
            }
            else if (position == 2) {
                return HistoryMatchPageFragment.newInstance("", "");
            }
           /* else if (position == 3) {
                return ExamplePageFragment.newInstance("", "");
            }*/
            else {
                return HistoryMeaningPageFragment.newInstance("","");
            }
        }
    }
