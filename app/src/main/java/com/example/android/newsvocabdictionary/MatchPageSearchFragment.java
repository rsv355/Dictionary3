...
public class MatchPageSearchFragment extends Fragment{
    ...
    public static MatchPageSearchFragment newInstance(String param1, String param2) {
        MatchPageSearchFragment fragment = new MatchPageSearchFragment();
    ...
    public MatchPageSearchFragment() {
    ...
    public void onResume() {
        super.onResume();
        CustomAdapter adapter = new CustomAdapter(getActivity(), MeaningPageFragmentSearch.match);
