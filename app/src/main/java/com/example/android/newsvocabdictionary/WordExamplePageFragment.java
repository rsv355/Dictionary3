...
public class WordExamplePageFragment extends Fragment {
    ...
    public static WordExamplePageFragment newInstance(String param1, String param2) {
        WordExamplePageFragment fragment = new WordExamplePageFragment();
    ...
    public WordExamplePageFragment() {
    ...
    public void onResume() {
        super.onResume();
          ...
          adapter = new CustomAdapter(getActivity(), WordMeaningPageFragment.exp,WordMeaningPageFragment.exp2);
