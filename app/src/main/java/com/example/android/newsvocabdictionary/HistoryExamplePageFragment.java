...
public class HistoryExamplePageFragment extends Fragment {
    ...
    public static HistoryExamplePageFragment newInstance(String param1, String param2) {
        HistoryExamplePageFragment fragment = new HistoryExamplePageFragment();
    ...
    public HistoryExamplePageFragment() {
   ...
   public  void updateMtehod(){
    ...
    public void onResume() {
       ...
       // Toast.makeText(getActivity(),"Exp called",Toast.LENGTH_SHORT).show();
        ...
        adapter = new CustomAdapter(getActivity(), HistoryMeaningPageFragment.exp,HistoryMeaningPageFragment.exp2);
        adapter.notifyDataSetChanged();
        list.invalidateViews();
        list.setAdapter(adapter);
    }
