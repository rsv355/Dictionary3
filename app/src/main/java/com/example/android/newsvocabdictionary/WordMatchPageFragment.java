...
public class WordMatchPageFragment extends Fragment{
    ...
    public static WordMatchPageFragment newInstance(String param1, String param2) {
        WordMatchPageFragment fragment = new WordMatchPageFragment();
    ...
    public void onResume() {
        ...
        adapter = new CustomAdapter(getActivity(), WordMeaningPageFragment.match);
