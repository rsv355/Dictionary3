...
public class HistoryMatchPageFragment extends Fragment{
    ...
    public static HistoryMatchPageFragment newInstance(String param1, String param2) {
        HistoryMatchPageFragment fragment = new HistoryMatchPageFragment();
    ...
    public HistoryMatchPageFragment() {
    ...
    public void onResume() {
      ...
      //  Toast.makeText(getActivity(), "Match called", Toast.LENGTH_SHORT).show();
        ...
        adapter = new CustomAdapter(getActivity(), HistoryMeaningPageFragment.match);
