...
public class MeanPageActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meaningpage);
 ...
 public class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0) {
                ...
                MeaningPageFragmentSearch bm = new MeaningPageFragmentSearch();
             ...
             /*   ft.replace(R.id.main_container, bm);
                ...
                return ExamplePageSearchFragment.newInstance("", "");
            }
            else if (position == 2) {
                return MatchPageSearchFragment.newInstance("", "");
            }
            else {
                return MeaningPageFragmentSearch.newInstance("", "");
            }
        }
    }
